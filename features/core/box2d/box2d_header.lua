...
---@return number x
---@return number y
function Box2dBody:GetPositionRawScaled(scale) end
...
---@return number
---@return number
function Box2dBody:GetLinearVelocityRaw() end
...
local Box2dFixtureDef = {
    ...
    ---@type Box2dShape|Box2dShapeTable|Box2dCircleShape|Box2dEdgeShape|Box2dPolygonShape|nil
    shape = nil,
...
---@class Box2dAABB
---@field lowerBound vector3
---@field upperBound vector3
