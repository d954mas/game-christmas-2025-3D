...
local plural      = require("features.core.localization.i18n.plural")
local interpolate = require("features.core.localization.i18n.interpolate")
local variants    = require("features.core.localization.i18n.variants")
